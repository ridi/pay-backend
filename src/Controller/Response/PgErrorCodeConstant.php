 ...
 *   @OA\Property(property="message", type="string", example="카드 등록 중 오류가 발생했습니다. (pg_response_message)")
 * )
 * @OA\Schema(
 ...
 *   @OA\Property(property="message", type="string", example="결제 승인 중 오류가 발생했습니다. (pg_response_message)")
 * )
 * @OA\Schema(
 ...
 *   @OA\Property(property="message", type="string", example="결제 취소 중 오류가 발생했습니다. (pg_response_message)")
 * )
 */
