...
use RidiPay\User\Model\BaseAbuseBlockPolicy;
...
class PasswordEntryBlockedException extends \Exception
{
    ...
    public function __construct(BaseAbuseBlockPolicy $policy, int $remaining_period_for_unblock)
    {
        ...
        $blocked_period_in_minute = floor($policy->getBlockedPeriod() / TimeConstant::SEC_IN_MINUTE);
        $remaining_period_for_unblock_in_minute = $remaining_period_for_unblock / TimeConstant::SEC_IN_MINUTE;
